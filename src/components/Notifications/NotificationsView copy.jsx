    ...
    >
      <filter.icon
        className={`w-3.5 h-3.5 sm:w-4 sm:h-4 z-10 ${
          isActive ? "text-white" : filter.iconColor
        }`}
      />
      ...
      <div
        className={`flex items-center justify-center min-w-[20px] h-5 sm:min-w-[24px] sm:h-6 text-xs font-bold rounded-full z-10 ${
          isActive
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 text-xs">
                    ...
                    >
                      ~
                      {task.estimatedTime
                        ? Math.ceil(task.estimatedTime / 60)
                        : 1}
                      h
                    </span>
                  </div>
    ...
    <div className="space-y-4">
      <div className="bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-500/20 rounded-2xl p-6 mb-6">
        ...
        <p className="text-sm text-gray-400">
          AI-powered recommendations based on your work patterns and task
          complexity
        </p>
      </div>
          ...
          <div
            ...
            className={`p-4 rounded-xl border transition-all duration-300 hover:scale-[1.02] ${
              isDark
                ...
                : "border-gray-200/50 bg-white/40 hover:bg-white/70"
            } backdrop-blur-sm`}
          >
                ...
                {suggestedDates.slice(0, 9).map((suggestion, index) => (
                  ...
                  >
                    ...
                    <div className="mb-2 sm:mb-3">
                      ...
                      >
                        {suggestion.workload === "light" && (
                          <span className="mr-1">🟢</span>
                        )}
                        {suggestion.workload === "medium" && (
                          <span className="mr-1">🟡</span>
                        )}
                        {suggestion.workload === "heavy" && (
                          <span className="mr-1">🔴</span>
                        )}
                        {suggestion.workload} day
                      </div>
            ...
            <div className="flex items-start gap-1.5 sm:gap-2 flex-shrink-0">
              ...
              {stats.overdue > 0 && (
                ...
                >
                  ...
                  <span
                    className={`flex items-center justify-center min-w-[16px] h-4 sm:min-w-[18px] sm:h-[18px] text-xs rounded-full font-semibold bg-white/20 text-white`}
                  >
                    {stats.overdue}
                  </span>
                </button>
